...
<head>
	<script type="text/javascript">
		var aJaxURL	          = "server-side/report/pledge_book.action.php";		//server side folder url
    ...
    <table class="display" id="example" >
        <thead>
            <tr id="datatable_header">
                ...
                <th style="width: 52%;">კლიენტი</th>
                <th style="width: 11%;">ორისის კოდი</th>
                <th style="width: 11%;">ს/ხ</th>
                <th style="width: 11%;">დაზღვევის<br>თანხა</th>
            </tr>
        </thead>
        <thead>
