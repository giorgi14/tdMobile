...
<head>
	<script type="text/javascript">
		var aJaxURL	          = "server-side/view/auto_mobile_type.action.php";		//server side folder url
		var tName	          = "example";													//table name
		var fName	          = "add-edit-form";												//form name
		var change_colum_main = "<'dataTable_buttons'T><'F'Cfipl>";
		    	
		$(document).ready(function () {        	
			LoadTable(tName,2,change_colum_main,aJaxURL);	
...
<body>
<div id="tabs">
<div class="callapp_head">ავტომობილის ტიპები<hr class="callapp_head_hr"></div>
<div id="button_area">
...
<td style="cursor: pointer;padding: 4px;" id="show_copy_prit_exel" myvar="0"><img alt="link" src="media/images/icons/select.png" height="14" width="14">
    ...
    <!-- jQuery Dialog -->
    <div id="add-edit-form" class="form-dialog" title="ავტომობილის ტიპი">
    	<!-- aJax -->
	</div>
</body>
</html>
