...
if ($file_type == 'receipt') {
    $data  .= ' <div style="size: 7in 9.25in; margin: 15mm 16mm 15mm 16mm;" id="dialog-form">
                        ...
                        <div style="width:100%; font-size: 12px; margin-top: 30px; padding: 0px 30px; text-align: left;">
    ...
    $data  .= '<div style="size: 7in 9.25in; margin: 15mm 16mm 15mm 16mm;" id="dialog-form">
                        ...
                        <div style="width:100%; margin-top: 60px;">
                            <table style="width:100%;">
                                <tr style="width:100%;">
                                    <td style="width:40%;"><label style="font-size: 12px; text-align: center;">გამსესხებელი:<br>შპს ”თი ჯი მობაილი”<br>ს/კ  205270277<br>მის. ქ.თბილისი,დოლიძის ქ.25/121</label></td>
                                    <td style="width:60%;"><label style="font-size: 12px; text-align: center;">მსესხებელი:<br>'.$res[name].'<br>პ/ნ  '.$res[pid].'<br>'.$res[actual_address].'<br>'.$res[juridical_address].'</label></td>
                                </tr>
                            </table>
                        </div>
                        <div style="width:100%; margin-top: 60px;">
    ...
    $data  .= '<div style="width:100%;">
                         ...
                         <div style="width:100%; font-size: 12px; margin-top: 15px; text-align: left;">
                        ...
                        <div style="width:100%; margin-top: 100px; font-size: 12px; text-align: left;">
                        ...
                        <div style="width:100%; margin-top: 60px; text-align: left;">პატივისცემით,</div>
    ...
    $data  .= '<div style="width:100%;">
                    ...
                    <div style="width:100%; font-size: 12px; margin-top: 10px; text-align: left;">
        ...
        $data  .= '<div style="width:100%;">
                        ...
                        <div style="width:100%; margin-top: 70px; text-align: left;">მსესხებელი: ___________________</div>
                   </div>';
